...
<head>
    ...
    <title>Login - Machine Tool Solution</title>
            ...
            <div class="row content_middle">
                <div class="col-lg-4 layoutAuthentication_content-wrapper">
                    <div class="text-center">
                        <img class="logo-admin" src="{{ asset('assets/img/logo.png') }}" alt="">
                    </div>
                    <div class="border-0 rounded-lg">
                        ...
                        <p class="text-center mt-5">{{ trans('language.label_have_account') }}? <a href="{{ url('registration') }}">{{ trans('language.label_register_now') }}</a></p>
                    </div>
                </div>
            </div>
        </div>
