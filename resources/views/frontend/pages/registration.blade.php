        ...
        <div class="form-container">
            <form action="{{ route('registration.post') }}" method="POST">
                ...
                <div class="d-flex gap-2 mb-1 w-100">
                    ...
                    <div class="form-floating mb-1 w-100">
                        <input type="text" class="form-control" id="floatingInput" placeholder="{{ trans('language.vat_reg_no') }}" value="{{old('vat_no')}}" name="vat_no" >
                        <label for="floatingInput">{{ trans('language.vat_reg_no') }}</label>
                    </div>
                </div>
                <div class="d-flex gap-2 mb-1 w-100">
                    <div class="form-floating mb-1 w-100">
