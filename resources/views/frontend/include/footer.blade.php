...
<footer id="footer">
    ...
    <div class="container footer-links-container">
        <div class="footer-links">
            ...
            <ul>
                <li><i class="bx bx-chevron-right"></i> <a href="{{ route('news') }}">{{ trans('language.news') }}</a>
                </li>
                <li><i class="bx bx-chevron-right"></i> <a
                        href="{{ route('about-us') }}">{{ trans('language.about_us') }}</a></li>
                <li><i class="bx bx-chevron-right"></i> <a
                        href="{{ route('contact-us') }}">{{ trans('language.contact') }}</a></li>
            </ul>
        </div>
        <div class="footer-links">
            ...
            <ul>
                @foreach ($footerBrands as $row)
                    <li><i class="bx bx-chevron-right"></i> <a
                            href="{{ route('brand.products', $row->id) }}">{{ $row->title }}</a></li>
                @endforeach
            </ul>
        </div>
        {{-- <div class="footer-links">
        ...
        <div class="footer-links">
            ...
            <ul>
                ...
                <li><i class="bx bx-chevron-right"></i> <a
                        href="{{ route('page', 'privacy-policy') }}">{{ trans('language.privacy_policy') }}</a></li>
                <li><i class="bx bx-chevron-right"></i> <a
                        href="{{ route('page', 'return-policy') }}">{{ trans('language.return_policy') }}</a></li>
            </ul>
        </div>
        <div class="footer-links">
            ...
            <div class="contact-area">
                ...
                <ul>
                    <li><i class="fa fa-phone"></i> Local (Dhaka): <a
                            href="tel:{{ Helper::getSettings('application_phone') }}">
                            {{ Helper::getSettings('application_phone') }}</a></li>
                    <li><i class="fa-solid fa-envelope"></i> <a
                            href="mailto:{{ Helper::getSettings('application_email') }}">{{ Helper::getSettings('application_email') }}</a>
                    </li>
                    <li class="align-items-baseline"><i class="fa-solid fa-location-dot"></i><a target="_blank"
                            href="https://maps.app.goo.gl/QyitijrSLcREscZx8">{{ Helper::getSettings('application_address') }}</a>
                    </li>
                </ul>
            </div>
            <div class="social-links mt-3">
                <a href="{{ Helper::getSettings('facebook_link') }}" target="_blank" class="facebook"><i
                        class="fa-brands fa-facebook-f"></i></a>
                <a href="{{ Helper::getSettings('twitter_link') }}" target="_blank" class="twitter"><i
                        class="fa-brands fa-x-twitter"></i></a>
                <a href="{{ Helper::getSettings('instagram_link') }}" target="_blank" class="instagram"><i
                        class="fa-brands fa-instagram"></i></a>
                <a href="{{ Helper::getSettings('linkedin_link') }}" target="_blank" class="linkedin-in"><i
                        class="fa-brands fa-linkedin-in"></i></a>
                <a href="{{ Helper::getSettings('youtube_link') }}" target="_blank" class="youtube"><i
                        class="fa-brands fa-youtube"></i></a>
                <a href="{{ route('review.us') }}" target="_blank" class="youtube"><i
...
<section class="copy-right">
    <div class="d-flex flex-column justify-content-center align-items-center py-2">
        <p class="m-1 text-light text-center">© {{ date('Y') }} <span
                class="fw-bold">{{ Helper::getSettings('application_name') }}</span>.
            {{ trans('language.copy_right') }}</p>
        <p class="m-1 text-light text-center">Developed by <a href="https://lasdigitalsolution.netlify.app/"
                class="text-light fw-bold" title="Best software company.">LAS Digital Solution</a></p>
    </div>
</section>
