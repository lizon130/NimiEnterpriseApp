<form id="partnerEditForm" action="{{ route('admin.partner.update', $partner->company_id)}}" method="post" enctype="multipart/form-data">
    ...
    <div class="modal-body">
        ...
        <div class="col-sm-12">
            ...
            <div class="w-100 d-flex gap-3 mb-3">
                <p class="mb-0">Partner Type:</p>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="type" @if($partner->type == 'Reseller') checked @endif value="Reseller" id="editReseller" required>
                    <label class="form-check-label" for="editReseller">Reseller</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="type" @if($partner->type == 'Distributor') checked @endif value="Distributor" id="editDistributor">
                    <label class="form-check-label" for="editDistributor">Distributor</label>
                </div>
            </div>
            ...
            <h6 class="mb-3 text-primary">Address & Security Information</h6>
            <div class="d-flex gap-1 mb-1 w-100">
                <div class="form-floating mb-1 w-100">
                    <input type="text" class="form-control" placeholder="Street Address" value="{{$partner->address}}" name="address" required>
    ...
    <div class="modal-footer">
        ...
        <button type="submit" id="editPartnerBtn" class="btn btn-primary">Update</button>
    </div>
</form>
