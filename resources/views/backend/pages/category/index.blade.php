...
@section('title', 'Category | '.Helper::getSettings('application_name') ?? 'Machine Tool Solution')
@section('content')
    <div class="container-fluid px-4">
        <h4 class="mt-2">Category Management</h4>
            ...
            <div class="card-header">
                <div class="row ">
                    <div class="col-12 d-flex justify-content-between">
                        <div class="d-flex align-items-center"><h5 class="m-0">Category List</h5></div>
        ...
        <script type="text/javascript">
            ...
            function getcategory(parent_category = null, title = null, status = null){
                var table = jQuery('#dataTable').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{ url('admin/category/get/list') }}",
                        type: 'GET',
                        data:{
