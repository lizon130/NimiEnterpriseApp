...
(function () {
  ...
  on('click', '.mobile-nav-toggle', function (e) {
	...
	if (this.classList.contains('fa-x')) {
        $('.show-on-mobile').removeClass('d-none')
		$('.show-on-mobile').addClass('d-block')
    }else{
		$('.show-on-mobile').removeClass('d-block')
		$('.show-on-mobile').addClass('d-none')
	}
  })
  
  on('click', '.fa-x', function (e) {
	  console.log('test')
	  alert('test')
	$('.show-on-mobile').removeClass('d-block')
	$('.show-on-mobile').addClass('d-none')
